...
for i_ in IndexInAccept[65::]:
    ...
    for j_ in range(imag_num):
        ...
        if SNR_network[IndexSumimage] > 12:
            if SNR_network[IndexSumimage] not in SNR_selected:
                ...
                fname_list = ['./Total_Sim_GW_Data_Lensed_' + Lens_Type + '/H1/H-H1_GWOSC_4KHZ_R1-'+str(int(Total_inject_time[Index_inject]))+'-4096_' + str(i) + "_" + str(save_index) + '.gwf' , './Total_Sim_GW_Data_Lensed_' + Lens_Type + '/L1/L-L1_GWOSC_4KHZ_R1-'+str(int(Total_inject_time[Index_inject]))+'-4096_' + str(i) + "_" + str(save_index) + '.gwf', './Total_Sim_GW_Data_Lensed_' + Lens_Type + '/V1/V-V1_GWOSC_4KHZ_R1-'+str(int(Total_inject_time[Index_inject]))+'-4096_' + str(i) + "_" + str(save_index) + '.gwf']
