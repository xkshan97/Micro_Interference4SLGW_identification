        ...
        for j_ in range(imag_num):
            ...
            if SNR_network[IndexSumimage] > 12:
                ...
                if Lens_Type == "Minimum": 
                    M_L = 0.38
                    z_L = lens_z_set[i_]
                    fileArea = "../Paper4_MicroLens_Modify/ResultMinimum/Total" + str(i) + "_" + str(save_index) + "ReadAreaMinimum.bin"
                    fileTime = "../Paper4_MicroLens_Modify/ResultMinimum/Total" + str(i) + "_" + str(save_index) + "ReadTimeMinimum.bin"
                    ...
                    M_L = 0.38
                    z_L = lens_z_set[i_]
                    fileArea = "../Paper4_MicroLens_Modify/ResultSaddle/Total" + str(i) + "_" + str(save_index) + "ReadAreaSaddle.bin"
                    fileTime = "../Paper4_MicroLens_Modify/ResultSaddle/Total" + str(i) + "_" + str(save_index) + "ReadTimeSaddle.bin"
                ...
                np.savetxt("../Paper4_MicroLens_Modify/Ffabs" + Lens_Type + "/Total" + str(i) + "_" + str(save_index) + ".csv", Ff_inter(freq_h1), delimiter=',')
                np.savetxt("../Paper4_MicroLens_Modify/ThetaF" + Lens_Type + "/Total" + str(i) + "_" + str(save_index) + ".csv", ThetaF_inter(freq_h1), delimiter=',')
                ...
                plt.xlim(1, 1000)
                plt.savefig('./IntermediaPlot_Gen_inter_Micro/Tilde_hf' + str(i) + '_' + str(save_index) + '.png', dpi=450)
                plt.close()
                ...
                plt.xlabel('t[s]')
                plt.ylabel('strain')
                plt.savefig('./IntermediaPlot_Gen_inter_Micro/waveform_' + str(i) + '_' +str(save_index) +'.png', dpi=450)
                plt.close()
                
                
                frame.write_frame('./Total_Sim_GW_Data_Lensed_' + Lens_Type + '/H1/H-H1_GWOSC_' + sample_RATE + '_R1-' + str(hoft_h1.start_time.gpsSeconds) + '-4096_' + str(i) + '_' + str(save_index) + '.gwf','H1:GWOSC_' + sample_RATE + '_R1_STRAIN',signal_with_noise_h1)
                frame.write_frame('./Total_Sim_GW_Data_Lensed_' + Lens_Type + '/L1/L-L1_GWOSC_' + sample_RATE + '_R1-' + str(hoft_l1.start_time.gpsSeconds) + '-4096_' + str(i) + '_' + str(save_index) + '.gwf','L1:GWOSC_' + sample_RATE + '_R1_STRAIN',signal_with_noise_l1)
                frame.write_frame('./Total_Sim_GW_Data_Lensed_' + Lens_Type + '/V1/V-V1_GWOSC_' + sample_RATE + '_R1-' + str(hoft_v1.start_time.gpsSeconds) + '-4096_' + str(i) + '_' + str(save_index) + '.gwf','V1:GWOSC_' + sample_RATE + '_R1_STRAIN',signal_with_noise_v1)
...
np.savetxt('./Lensed_SampleResult_Micro/Total_inject_time.csv', Result1)
np.savetxt('./Lensed_SampleResult_Micro/trigger_time_H1.csv', Result2, delimiter=',')
np.savetxt('./Lensed_SampleResult_Micro/trigger_time_L1.csv', Result3, delimiter=',')
np.savetxt('./Lensed_SampleResult_Micro/trigger_time_V1.csv', Result4, delimiter=',')
np.savetxt('./Lensed_SampleResult_Micro/gw_duration.csv', Result5, delimiter=',')
np.savetxt('./Lensed_SampleResult_Micro/gw_duration_20.csv', Result6, delimiter=',')
np.savetxt('./Lensed_SampleResult_Micro/dt_h1_from_earth_center.csv', Result7, delimiter=',')
np.savetxt('./Lensed_SampleResult_Micro/dt_l1_from_earth_center.csv', Result8, delimiter=',')      
np.savetxt('./Lensed_SampleResult_Micro/dt_v1_from_earth_center.csv', Result9, delimiter=',')      
