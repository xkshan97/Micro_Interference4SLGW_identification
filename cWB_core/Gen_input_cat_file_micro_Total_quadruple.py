...
match_total = np.loadtxt('./Theory_match_total_quadruple/match.csv', delimiter=',')
Mz_total = np.loadtxt('./Theory_match_total_quadruple/chirp_mass.csv', delimiter=',')
SNR_Lens_gtr_12_sum = np.loadtxt('./Theory_match_total_quadruple/SNR_total.csv', delimiter=',')
redshift_sampled = np.loadtxt('./Theory_match_total_quadruple/redshift_sampled.csv', delimiter=',')

selected_index1 = np.where((match_total<0.995)&(SNR_Lens_gtr_12_sum>50)&(SNR_Lens_gtr_12_sum<150)&(Mz_total>20)&(redshift_sampled < 3))
selected_index2 = np.where((match_total<0.999)&(SNR_Lens_gtr_12_sum>150)&(Mz_total>20)&(redshift_sampled < 3)) 
...
redshift_selected_tmp = redshift_sampled[selected_index]
cummulative_num = []
...
freq_index = 0
with open('./Total_Data_start_time_and_snr_and_match_and_outdir_name_quadruple/with_micro.txt', 'w') as f0:
        ...
        for j_ in range(imag_num):
            if SNR_network[IndexSumimage] > 12:
                if SNR_network[IndexSumimage] in SNR_selected_tmp:
                    index_in_total_time = np.where(SNR_Lens_gtr_12_sum == SNR_network[IndexSumimage])[0][0]
                    ...
                    #input
                    with open('./input_micro_Total_quadruple/H1_' + str(int(Total_inject_time[index_in_total_time])) + '_' + str(i) + '_' + str(save_index) + '.in', 'w') as f:
                        f.write('/home/cWB_docker/CE_Micro/catalog/GWTC-1-confident/GW150914/FRAMES/' + Lens_Type + '/H1/H-H1_GWOSC_4KHZ_R1-' + str(int(Total_inject_time[index_in_total_time])) + '-4096'+ '_' + str(i) + '_' + str(save_index) + '.gwf')
                    with open('./input_micro_Total_quadruple/L1_' + str(int(Total_inject_time[index_in_total_time])) + '_' + str(i) + '_' + str(save_index) + '.in', 'w') as f:
                        f.write('/home/cWB_docker/CE_Micro/catalog/GWTC-1-confident/GW150914/FRAMES/' + Lens_Type + '/L1/L-L1_GWOSC_4KHZ_R1-' + str(int(Total_inject_time[index_in_total_time])) + '-4096'+ '_' + str(i) + '_' + str(save_index) + '.gwf')
                    with open('./input_micro_Total_quadruple/V1_' + str(int(Total_inject_time[index_in_total_time])) + '_' + str(i) + '_' + str(save_index) + '.in', 'w') as f:
                        f.write('/home/cWB_docker/CE_Micro/catalog/GWTC-1-confident/GW150914/FRAMES/' + Lens_Type + '/V1/V-V1_GWOSC_4KHZ_R1-' + str(int(Total_inject_time[index_in_total_time])) + '-4096'+ '_' + str(i) + '_' + str(save_index) + '.gwf')
                    
                    # #copy file to FRAMES
                    shutil.copy('../Paper4_CE_Modify/Total_Sim_GW_Data_Lensed_' + Lens_Type + '_with_micro' + '_quadruple/H1/H-H1_GWOSC_4KHZ_R1-' + str(int(Total_inject_time[index_in_total_time])) + '-4096_' + str(i) + '_' + str(save_index) + '.gwf', './FRAMES_micro_Total_quadruple/' + Lens_Type + '/H1/H-H1_GWOSC_4KHZ_R1-' + str(int(Total_inject_time[index_in_total_time])) + '-4096_' + str(i) + '_' + str(save_index) + '.gwf')
                    shutil.copy('../Paper4_CE_Modify/Total_Sim_GW_Data_Lensed_' + Lens_Type + '_with_micro' + '_quadruple/L1/L-L1_GWOSC_4KHZ_R1-' + str(int(Total_inject_time[index_in_total_time])) + '-4096_' + str(i) + '_' + str(save_index) + '.gwf', './FRAMES_micro_Total_quadruple/' + Lens_Type + '/L1/L-L1_GWOSC_4KHZ_R1-' + str(int(Total_inject_time[index_in_total_time])) + '-4096_' + str(i) + '_' + str(save_index) + '.gwf')
                    shutil.copy('../Paper4_CE_Modify/Total_Sim_GW_Data_Lensed_' + Lens_Type + '_with_micro' + '_quadruple/V1/V-V1_GWOSC_4KHZ_R1-' + str(int(Total_inject_time[index_in_total_time])) + '-4096_' + str(i) + '_' + str(save_index) + '.gwf', './FRAMES_micro_Total_quadruple/' + Lens_Type + '/V1/V-V1_GWOSC_4KHZ_R1-' + str(int(Total_inject_time[index_in_total_time])) + '-4096_' + str(i) + '_' + str(save_index) + '.gwf')
                    
                    #DQ
                    start_gps = int(Total_inject_time[index_in_total_time] + 1000)
                    end_gps = int(start_gps + 3000)
                    with open('./DQ_micro_Total_quadruple/H1_' + str(int(Total_inject_time[index_in_total_time])) + '_' + str(i) + '_' + str(save_index) + '.txt', 'w') as f:
                        f.write("%s %s\n"%(start_gps, end_gps))
                    with open('./DQ_micro_Total_quadruple/L1_' + str(int(Total_inject_time[index_in_total_time])) + '_' + str(i) + '_' + str(save_index) + '.txt', 'w') as f:
                        f.write("%s %s\n"%(start_gps, end_gps))
                    with open('./DQ_micro_Total_quadruple/V1_' + str(int(Total_inject_time[index_in_total_time])) + '_' + str(i) + '_' + str(save_index) + '.txt', 'w') as f:
                        f.write("%s %s\n"%(start_gps, end_gps))
                    
                    excel_name_match.append(str(int(Total_inject_time[index_in_total_time])) + '_' + str(i) + '_' + str(save_index))
                    inject_time_set.append(int(Total_inject_time[index_in_total_time]))
                    ...
                    np.savetxt('./Micro_signal_Total_quadruple/freq_'+str(int(i))+'_'+str(int(save_index))+'.csv', freq_h1, delimiter=',') 
                    np.savetxt('./Micro_signal_Total_quadruple/lens_signal_'+str(int(i))+'_'+str(int(save_index))+'.csv', abs(tilde_signal_h1_lensed * sqrt_mag_abs), delimiter=',') 
                    np.savetxt('./Micro_signal_Total_quadruple/time_'+str(int(i))+'_'+str(int(save_index))+'.csv', signal_h1.sample_times, delimiter=',') 
                    np.savetxt('./Micro_signal_Total_quadruple/time_lens_signal_'+str(int(i))+'_'+str(int(save_index))+'.csv', signal_h1_lensed, delimiter=',') 
                    ...
                    plt.savefig('./IntermediaPlot_quadruple/Micro_selected/' + str(int(Total_inject_time[index_in_total_time])) + '_' + str(i) + '_' + str(save_index) + '.png', dpi=450)
                    plt.close()
                    # plt.savefig('./FreqDomain_figure_micro_fstar/'+str(int(Total_inject_time[index_in_total_time])) + '_' + str(i) + '_' + str(save_index) + '_' + f_star+'.png', dpi=450)
                    # plt.close()
                    ...
                    f0.write('../Paper4_CE_Modify/outdir_Lensed_'+Lens_Type+'_with_micro_quadruple/outdir'+str(int(i))+'_'+str(int(save_index))+'/H1_L1_V1_result.json'+'\n')
            ...
            IndexSumimage += 1
# plt.plot(match)
np.savetxt('./Total_Data_start_time_and_snr_and_match_and_outdir_name_quadruple/match.csv', match, delimiter=',')
np.savetxt('./Total_Data_start_time_and_snr_and_match_and_outdir_name_quadruple/excel_name_match.csv', excel_name_match, delimiter=',', fmt='%s')
np.savetxt('./Total_Data_start_time_and_snr_and_match_and_outdir_name_quadruple/SNR_selected.csv', SNR_selected, delimiter=',')
np.savetxt('./Total_Data_start_time_and_snr_and_match_and_outdir_name_quadruple/IndexInAccept.csv', IndexInAccept, delimiter=',')
np.savetxt('./Total_Data_start_time_and_snr_and_match_and_outdir_name_quadruple/inject_time_set.csv', inject_time_set, delimiter=',')
np.savetxt('./Total_Data_start_time_and_snr_and_match_and_outdir_name_quadruple/chirp_mass.csv', Mz, delimiter=',')
np.savetxt('./Total_Data_start_time_and_snr_and_match_and_outdir_name_quadruple/mass_ratio.csv', mass_ratio, delimiter=',')
np.savetxt('./Total_Data_start_time_and_snr_and_match_and_outdir_name_quadruple/merger_freq.csv', merger_freq_set, delimiter=',')
np.savetxt('./Total_Data_start_time_and_snr_and_match_and_outdir_name_quadruple/ringdown_freq.csv', ringdown_freq_set, delimiter=',')
np.savetxt('./Total_Data_start_time_and_snr_and_match_and_outdir_name_quadruple/reference_det.csv', reference_det, delimiter=',', fmt='%s')