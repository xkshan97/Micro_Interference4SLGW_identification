...
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name/SNR_select_index_unlens.csv', Index100_Index_SNR_network_G_12, delimiter=',')
...
ringdown_freq_set = []
reference_det = []
with open('./Data_start_time_and_snr_and_match_and_outdir_name/unlens.txt', 'w') as f0:
    for index_i in tqdm(range(len(Index100_Index_SNR_network_G_12))):
        ...
        #找到文件所对应的inject time
        file_name_list_tmp = os.listdir('../Paper4_CE_Modify/Sim_GW_Data/H1')
        ...
        with open('./input_unlens/H1_' + Data_start_time + '_' + str(i) + '.in', 'w') as f:
            f.write('/home/cWB_docker/CE_Unlens/catalog/GWTC-1-confident/GW150914/FRAMES/H1/H-H1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096'+ '_' + str(i) + '.gwf')
        with open('./input_unlens/L1_' + Data_start_time + '_' + str(i) + '.in', 'w') as f:
            f.write('/home/cWB_docker/CE_Unlens/catalog/GWTC-1-confident/GW150914/FRAMES/L1/L-L1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096'+ '_' + str(i) + '.gwf')
        with open('./input_unlens/V1_' + Data_start_time + '_' + str(i) + '.in', 'w') as f:
            f.write('/home/cWB_docker/CE_Unlens/catalog/GWTC-1-confident/GW150914/FRAMES/V1/V-V1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096'+ '_' + str(i) + '.gwf')
        
        
        #copy file to FRAMES
        #总数据
        if os.path.exists('./FRAMES_unlens/H1/H-H1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096_' + str(i) + '.gwf'):
            pass
        else:
            shutil.copy('../Paper4_CE_Modify/Sim_GW_Data/H1/H-H1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096_' + str(i) + '.gwf', './FRAMES_unlens/H1/H-H1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096_' + str(i) + '.gwf')
            shutil.copy('../Paper4_CE_Modify/Sim_GW_Data/L1/L-L1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096_' + str(i) + '.gwf', './FRAMES_unlens/L1/L-L1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096_' + str(i) + '.gwf')
            shutil.copy('../Paper4_CE_Modify/Sim_GW_Data/V1/V-V1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096_' + str(i) + '.gwf', './FRAMES_unlens/V1/V-V1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096_' + str(i) + '.gwf')
        ...
        plt.xlim(0,1200)
        plt.savefig('./IntermediaPlot/Unlens_selected/' + Data_start_time + '_' + str(i) + '.png', dpi=450)
        plt.close()
        ...
        with open('./DQ_unlens/H1_' + Data_start_time + '_' + str(i) + '.txt', 'w') as f:
            f.write("%s %s\n"%(start_gps, end_gps))
        with open('./DQ_unlens/L1_' + Data_start_time + '_' + str(i) + '.txt', 'w') as f:
            f.write("%s %s\n"%(start_gps, end_gps))
        with open('./DQ_unlens/V1_' + Data_start_time + '_' + str(i) + '.txt', 'w') as f:
            f.write("%s %s\n"%(start_gps, end_gps))
        ...
        f0.write('../Paper4_CE_Modify/outdir_unlensed/outdir'+str(i) + '/H1_L1_V1_result.json'+'\n')


        
   
     
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name/Data_start_time_set_unlens.csv', Data_start_time_set_unlens, delimiter=',')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name/SNR_selected_unlens.csv', SNR_selected_unlens, delimiter=',')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name/excel_name_match_unlens.csv', excel_name_match_unlens, delimiter=',', fmt='%s')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name/chirp_mass_unlens.csv', Mz, delimiter=',')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name/mass_ratio_unlens.csv', mass_ratio, delimiter=',')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name/merger_freq_unlens.csv', merger_freq_set, delimiter=',')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name/ringdown_freq_unlens.csv', ringdown_freq_set, delimiter=',')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name/reference_det.csv', reference_det, delimiter=',', fmt='%s')
