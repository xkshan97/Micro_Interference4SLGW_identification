...
Index100_Index_SNR_network_G_12 = Index_SNR_network_G_12

SNR_selected_unlens = SNR_network[Index100_Index_SNR_network_G_12]
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name_big_sample/SNR_select_index_unlens.csv', Index100_Index_SNR_network_G_12, delimiter=',')
...
ringdown_freq_set = []
reference_det = []
with open('./Data_start_time_and_snr_and_match_and_outdir_name_big_sample/unlens.txt', 'w') as f0:
    for index_i in tqdm(range(len(Index100_Index_SNR_network_G_12))):
        ...
        #找到文件所对应的inject time
        file_name_list_tmp = os.listdir('../Paper4_CE_Modify/Sim_GW_Data_big_sample/H1')
        ...
        with open('./input_unlens_big_sample/H1_' + Data_start_time + '_' + str(i) + '.in', 'w') as f:
            f.write('/disk1/home/shanxk/work/Paper4_CE_Modify/Sim_GW_Data_big_sample/H1/H-H1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096'+ '_' + str(i) + '.gwf')
        with open('./input_unlens_big_sample/L1_' + Data_start_time + '_' + str(i) + '.in', 'w') as f:
            f.write('/disk1/home/shanxk/work/Paper4_CE_Modify/Sim_GW_Data_big_sample/L1/L-L1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096'+ '_' + str(i) + '.gwf')
        with open('./input_unlens_big_sample/V1_' + Data_start_time + '_' + str(i) + '.in', 'w') as f:
            f.write('/disk1/home/shanxk/work/Paper4_CE_Modify/Sim_GW_Data_big_sample/V1/V-V1_GWOSC_' + sample_RATE + '_R1-' + Data_start_time + '-4096'+ '_' + str(i) + '.gwf')
        ...
        plt.xlim(0,1200)
        plt.savefig('./IntermediaPlot/Unlens_selected_big_sample/' + Data_start_time + '_' + str(i) + '.png', dpi=450)
        plt.close()
        ...
        with open('./DQ_unlens_big_sample/H1_' + Data_start_time + '_' + str(i) + '.txt', 'w') as f:
            f.write("%s %s\n"%(start_gps, end_gps))
        with open('./DQ_unlens_big_sample/L1_' + Data_start_time + '_' + str(i) + '.txt', 'w') as f:
            f.write("%s %s\n"%(start_gps, end_gps))
        with open('./DQ_unlens_big_sample/V1_' + Data_start_time + '_' + str(i) + '.txt', 'w') as f:
            f.write("%s %s\n"%(start_gps, end_gps))
        ...
        f0.write('../Paper4_CE_Modify/outdir_unlensed_big_sample/outdir'+str(i) + '/H1_L1_V1_result.json'+'\n')


        
   
     
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name_big_sample/Data_start_time_set_unlens.csv', Data_start_time_set_unlens, delimiter=',')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name_big_sample/SNR_selected_unlens.csv', SNR_selected_unlens, delimiter=',')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name_big_sample/excel_name_match_unlens.csv', excel_name_match_unlens, delimiter=',', fmt='%s')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name_big_sample/chirp_mass_unlens.csv', Mz, delimiter=',')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name_big_sample/mass_ratio_unlens.csv', mass_ratio, delimiter=',')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name_big_sample/merger_freq_unlens.csv', merger_freq_set, delimiter=',')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name_big_sample/ringdown_freq_unlens.csv', ringdown_freq_set, delimiter=',')
np.savetxt('./Data_start_time_and_snr_and_match_and_outdir_name_big_sample/reference_det.csv', reference_det, delimiter=',', fmt='%s')
