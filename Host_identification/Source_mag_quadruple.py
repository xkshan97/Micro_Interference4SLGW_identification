...
#检验一下0.01误差范围内的星等分布
index_range = np.where(dis_abs < 0.05)[0]
mag_range = []
JWST_mag_range = []
axis_ratio_range = []
...
plt.grid()
plt.legend()
plt.savefig('./SampleResult_GWGalaxy_quadruple/mag_Res_' + str(index) +'.png', dpi=450)
plt.close()
np.savetxt('./SampleResult_GWGalaxy_quadruple/mag_range_' + str(index) + '.csv', mag_range, delimiter=',') 
np.savetxt('./SampleResult_GWGalaxy_quadruple/mag_range_weight_by_SFR_50' + str(index) + '.csv', mag_weight_by_SFR_50, delimiter=',')
np.savetxt('./SampleResult_GWGalaxy_quadruple/mag_range_weight_by_SFR_100' + str(index) + '.csv', mag_weight_by_SFR_100, delimiter=',')
np.savetxt('./SampleResult_GWGalaxy_quadruple/JWST_mag_range_' + str(index) + '.csv', JWST_mag_range, delimiter=',') 
np.savetxt('./SampleResult_GWGalaxy_quadruple/JWST_mag_range_weight_by_SFR_50' + str(index) + '.csv', JWST_mag_weight_by_SFR_50, delimiter=',')
np.savetxt('./SampleResult_GWGalaxy_quadruple/JWST_mag_range_weight_by_SFR_100' + str(index) + '.csv', JWST_mag_weight_by_SFR_100, delimiter=',')
...
np.savetxt('./SampleResult_GWGalaxy_quadruple/mag_Res_' + str(index) + '.csv', mag_Res, delimiter=',')
np.savetxt('./SampleResult_GWGalaxy_quadruple/JWST_mag_Res_' + str(index) + '.csv', JWST_mag_Res, delimiter=',')
