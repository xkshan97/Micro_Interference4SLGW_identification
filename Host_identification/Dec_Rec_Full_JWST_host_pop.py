...
def Main_func(index_tmp):
    ...
    kwargs_lens_sigma.append({'theta_E': 0.002, 'e1': 0.005, 'e2': 0.005,
                            'center_x': 0.005, 'center_y': 0.005})
    kwargs_lower_lens.append({'theta_E': 0.001, 'e1': -1, 'e2': -1, 'center_x': -5, 'center_y': -5})
    kwargs_upper_lens.append({'theta_E': 5., 'e1': 1, 'e2': 1, 'center_x': 5, 'center_y': 5})
    ...
    kwargs_source_sigma.append({'n_sersic': 0.005, 'R_sersic': 0.001, 'e1': 0.0005, 'e2': 0.0005, 'center_x': 0.002, 'center_y': 0.002})
    kwargs_lower_source.append({'e1': -1, 'e2': -1, 'R_sersic': 0.001, 'n_sersic': 0.001, 'center_x': -5, 'center_y': -5})
    kwargs_upper_source.append({'e1': 1, 'e2': 1, 'R_sersic': 2, 'n_sersic': 7., 'center_x': 5, 'center_y': 5})
    ...
    kwargs_lens_light_sigma.append({'n_sersic': 0.001, 'R_sersic': 0.003, 'e1': 0.0005, 'e2': 0.0005, 'center_x': 0.001, 'center_y': 0.001})
    kwargs_lower_lens_light.append({'e1': -1, 'e2': -1, 'R_sersic': 0.001, 'n_sersic': .5, 'center_x': -5, 'center_y': -5})
    kwargs_upper_lens_light.append({'e1': 1, 'e2': 1, 'R_sersic': 50, 'n_sersic': 5., 'center_x': 5, 'center_y': 5})
    ...
    fitting_kwargs_list = [['PSO', {'sigma_scale': 1., 'n_particles': 200, 'n_iterations': 200}],
                        ['MCMC', {'n_burn': 300, 'n_run': 800, 'n_walkers': 200, 'sigma_scale': .1}]
            ]
